...
<div class="flex flex-col bg-white py-2 px-3 w-form-div">
    ...
    <input type="{{ $type }}" id="{{ $id }}" name="{{ $name }}" class="pl-3 bg-white w-full text-sm border border-gray-400" value="{{ old($name, $value) }}" data-date-multiple="{{ $dateMultiple }}" autocomplete="off">
</div>